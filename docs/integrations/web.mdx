...
Mindsmiths platform allows developers to easily create beautiful user experiences on the web.
This integration provides a seamless connection between our platform and web-based interfaces, giving developers the ability to create intuitive and engaging interfaces for their solutions.

Here, we'll cover all the information needed to get started with building web interfaces, including step-by-step instructions, best practices, and examples.

Let's get started!

## Getting started

The integration for building web interfaces is called **Armory**. It is a web templating service that allows you to create dynamic web applications using an intuitive templating system.

<div class="code-preview">
  <img src="/img/integrations/web/armory-screen-structure.png" />

  ```java
  ArmoryAPI.show(
      getConnection("armory"),
      new Screen("welcome")
          .add(new Title("Welcome to Armory ❤️"))
          .add(new Description(
              "Armory has predefined components that make it easy to create new screens." +
              "Here, we're just using a title, description and a submit button."
          ))
          .add(new SubmitButton("submit", "Cool, let's go!"))
  );
  ```
</div>
...
![Armory screen structure](/img/integrations/web/armory-screen-chaining.png)

[graphic](/img/integrations/web/Screen.png#center)
...
![graphic](/img/integrations/web/Screen2.png#center)
